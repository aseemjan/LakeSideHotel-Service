...
import com.aseem.lakesidehotel.exception.RoleAlreadyExistException;

import com.aseem.lakesidehotel.model.Role;
import com.aseem.lakesidehotel.model.User;

import com.aseem.lakesidehotel.service.IRoleService;
...
public class RoleController {
    ...
    public ResponseEntity<String> createRole(@RequestBody Role theRole){
        try{
            ...
            return ResponseEntity.ok().body("New role created successfully!");
